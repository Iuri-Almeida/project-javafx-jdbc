...
public class SellerFormController implements Initializable {
	...
	public void onBtnSaveAction(ActionEvent event) {
		...
		try {
			...
			Alerts.showAlert("Error saving object", null, e2.getMessage(), AlertType.ERROR);
		}
	}
	
	private void notifyDataChangeListeners() {
		
		for (DataChangeListener listener : dataChangeListeners) listener.onDataChange();
	...
	private Seller getFormData() {
		...
		if (txtEmail.getText() == null || txtEmail.getText().trim().equals("")) exception.addError("email", "Field can't be empty");
		...
		if (txtBaseSalary.getText() == null || txtBaseSalary.getText().trim().equals("")) exception.addError("baseSalary", "Field can't be empty");
	...
	public void loadAssociatedObjects() {
		...
		if (departmentService == null) throw new IllegalStateException("DepartmentService was null");
